...
def get_parser():
    ...
    parser.add_argument('--checkpoint', default='last-E200_WordRate0.9840_ExpRate0.5885.pth', help='the path of checkpoint')
...
if __name__ == "__main__":
    ...
    model = Inference(params, args.draw_map)
    ...
    with torch.no_grad():
        for line in tqdm(lines):
            ...
            probs, _ = model(image, input_ques, name)  # attention map not add
    ...
    with open("total.json", "w", encoding='utf-8') as fb:
